...
private fun ConstraintSystemBuilderImpl.generateNewBound(bound: Bound, substitution: Bound) {
    ...
    val substitutedType = when (substitution.kind) {
        ...
        UPPER_BOUND -> CapturedType(TypeProjectionImpl(Variance.OUT_VARIANCE, substitution.constrainingType), isFromInference = true)
        LOWER_BOUND -> CapturedType(TypeProjectionImpl(Variance.IN_VARIANCE, substitution.constrainingType), isFromInference = true)
    }
