 ...
 */
@Deprecated("This constant will become private soon, use it's value instead.", ReplaceWith("4096"))
public val defaultBlockSize: Int = 4096
/**
 * Returns the minimum block size for forEachBlock().
 */
@Deprecated("This constant will become private soon, use it's value instead.", ReplaceWith("512"))
